...
def main():
    model = load_word2vec_model(r"G:\NLP\Code\NLP_Code\6_文本分类任务\支持向量机文本分类\model.w2v")
    train_x, train_y = load_sentence(r"G:\NLP\Code\NLP_Code\6_文本分类任务\data\train_tag_news.json", model)
    test_x, test_y = load_sentence(r"G:\NLP\Code\NLP_Code\6_文本分类任务\data\valid_tag_news.json", model)
    classifier = SVC()
