...
import jieba
import numpy as np
from similarity_function import editing_distance, jaccard_distance,BM25
...
if __name__ == '__main__':
    ...
    qas = QASystem(r"G:\NLP\Code\NLP_Code\7_文本匹配任务\data\train.json", "bm25")
    res = qas.query(question)
    print(res)
    
    qas = QASystem(r"G:\NLP\Code\NLP_Code\7_文本匹配任务\data\train.json", "word2vec")
    res = qas.query(question)
    print(res)
    #
    # while True:
