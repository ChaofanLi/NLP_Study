...
def load_trained_language_model(path):
    ...
    vocab = build_vocab(r"G:\NLP\Code\NLP_Code\4_语言模型\rnn_language_model\vocab.txt")      # 加载字表
...
#加载训练好的所有模型
def load_models():
    model_paths = os.listdir(r"G:\NLP\Code\NLP_Code\4_语言模型\rnn_language_model\model")
    class_to_model = {}
    for model_path in model_paths:
        class_name = model_path.replace(".pth", "")
        model_path = os.path.join(r"G:\NLP\Code\NLP_Code\4_语言模型\rnn_language_model\model", model_path)
