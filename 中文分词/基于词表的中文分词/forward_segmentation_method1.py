...
if __name__=="__main__":
    string = "测试字符串"
    word_dict, max_len = load_word_dict(r"G:\NLP\Code\NLP_Code\中文分词\基于词表的分词\dict.txt")
    # print(cut_method1(string, word_dict, max_len))
    main(cut_method1, r"G:\NLP\Code\NLP_Code\中文分词\基于词表的分词\corpus.txt", r"G:\NLP\Code\NLP_Code\中文分词\基于词表的分词\cut_method1_output.txt")
    # 耗时：2.4810409545898438s