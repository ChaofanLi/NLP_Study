...
if __name__=="__main__":
    ...
    # string = "伴随着优雅的西洋乐"
    # string = "非常的幸运"
    prefix_dict = load_prefix_word_dict(r"G:\NLP\Code\NLP_Code\中文分词\基于词表的分词\dict.txt")
    # print(cut_method2(string, prefix_dict))
    # print(json.dumps(prefix_dict, ensure_ascii=False, indent=2))
    main(cut_method2, r"G:\NLP\Code\NLP_Code\中文分词\基于词表的分词\corpus.txt", r"G:\NLP\Code\NLP_Code\中文分词\基于词表的分词\cut_method2_output.txt")
    # 耗时： 1.3617818355560303s